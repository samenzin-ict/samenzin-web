...
export const nl = {
  ...
  portalNavEvents: 'Mijn evenementen',
  portalRoleVrijwilliger: 'Vrijwilliger',
  portalRoleLid: 'Lid',
  portalRoleBestuur: 'Bestuurslid',
  portalCommissionPrefix: 'commissie',
  portalStatOpenTasks: 'Open taken',
  portalStatThisWeek: 'Deze week',
  portalStatDone: 'Afgerond',
  portalStatHours: 'Uren',
  portalTasksTitle: 'Mijn taken',
  portalTasksEmpty: 'U heeft op dit moment geen taken.',
  portalTasksAssignedTo: 'Toegewezen aan',
  portalTasksDueToday: 'Vandaag',
  portalTasksDueTomorrow: 'Morgen',
  portalTasksDueThisWeek: 'Deze week',
  portalTasksOverdue: 'Te laat',
  portalTasksDone: 'Afgerond',
  portalTasksNoDeadline: 'Geen deadline',
  portalTasksToggleDone: 'Markeer als afgerond',
  portalTasksToggleOpen: 'Markeer als niet afgerond',
  portalTasksError: 'De taak kon niet worden bijgewerkt. Probeer het later opnieuw.',
  portalCoursesTitle: 'Mijn cursussen',
  portalCoursesEmpty: 'U volgt op dit moment geen cursussen.',
  portalCoursesProgress: 'Voortgang',
  portalEventsTitle: 'Mijn evenementen',
  portalEventsEmpty: 'U bent op dit moment voor geen enkel evenement aangemeld.',
  portalEventsAttended: 'Aanwezig geweest',
  portalEventsUpcoming: 'Aankomend',
  portalEventsPast: 'Geweest',
