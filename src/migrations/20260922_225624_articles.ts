...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__articles_v_published_locale" AS ENUM('nl');
  ...
  CREATE TABLE "articles" (
  	...
  	"category" "enum_articles_category" DEFAULT 'nieuws',
  ...
  CREATE TABLE "_articles_v" (
  	...
  	"version_category" "enum__articles_v_version_category" DEFAULT 'nieuws',
  ...
  CREATE INDEX "articles_tags_locale_idx" ON "articles_tags" USING btree ("_locale");
  ...
  CREATE INDEX "_articles_v_version_tags_locale_idx" ON "_articles_v_version_tags" USING btree ("_locale");
